      ...
      <>
        ...
        <div
          ...
          <div className="ergonza-platform-wrapper-mobile">
            ...
            <div className="ergonza-platform-subheader-mobile">{t("ergonza-platform-subheader")}</div>
      ...
      <>
        ...
        <div
          ...
          <div className="ergonza-platform-wrapper">
            ...
            <div className="ergonza-platform-subheader">{t("ergonza-platform-subheader")}</div>
